...
temp1 = table;
for i=1:4
    temp1{i,"alg_name"} = alg_name;
    temp1{i,"sbi"} = 0;     temp1{i,"experiment_CS"} = CS;
    temp1{i,"experiment_d"} = d;     temp1{i,"experiment_weight"} = weights(i);
    temp1{i,"nr_reps"} = nr_reps;     temp1{i,"pop_size"} = pop_size;
    temp1{i,"do_plot"} = do_plot;     temp1{i,"do_save"} = do_save;
end
temp2 = temp1;
temp2.sbi = ones(4,1);
T = [T;temp1;temp2];
